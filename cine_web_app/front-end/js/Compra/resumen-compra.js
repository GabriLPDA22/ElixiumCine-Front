...
function fetchMovieData(movieTitle) {
    const apiUrl = 'http://localhost:22951/api/Movie/GetPeliculas';
...
function fetchProductData(productIds) {
    const apiUrl = `http://localhost:22951/api/Productos/GetProductos?ids=${productIds.join(',')}`;
...
async function createOrder() {
    ...
    try {
        const response = await fetch('http://localhost:22951/api/Pedido/CreatePedido', {
            method: 'POST',
