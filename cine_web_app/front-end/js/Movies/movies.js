...
async function loadMovieDetails(id) {
    try {
        const response = await fetch(`http://localhost:22951/api/Movie/GetPeliculaById?id=${id}`);
...
async function fetchCinemaName(cineId) {
    try {
        ...
        const response = await fetch(`http://localhost:22951/api/Cine/GetCineById?cineId=${cineId}`);
...
async function loadCinemas() {
    try {
        const response = await fetch('http://localhost:22951/api/Cine/GetCines');
...
async function loadDaysAndSessions(cineId) {
    try {
        ...
        const response = await fetch(`http://localhost:22951/api/Cine/GetCineConPeliculas?cineId=${cineId}`);
